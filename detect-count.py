...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    for path, im, im0s, vid_cap, s in dataset:
        # 1,2,3,4分别代表左上，右上，右下，左下四个点坐标，即（480,270）（700,270）（700,810）（480,810）
        hl1 = 270 / 1080  # 左上纵坐标/图片高度
        wl1 = 620 / 1920  # 左上横坐标/图片宽度
        hl2 = 270 / 1080  # 右上横坐标/图片宽度
        wl2 = 820 / 1920  # 右上横坐标/图片宽度
        hl3 = 630 / 1080  # 右下横坐标/图片宽度
        wl3 = 820 / 1920  # 右下横坐标/图片宽度
        hl4 = 630 / 1080  # 左下横坐标/图片宽度
        wl4 = 620 / 1920  # 左下横坐标/图片宽度
        if webcam:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if view_img:
                ...
                cv2.putText(im0, text, (180, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 3)
